 ...
 * 
 * ao aplicar o metado "sort", eu faço uma ordenação no que eu quero ver.
 * quando se tem o "-1" significa que eu estou fazendo busca por ordem decrescente.
 * quando eu utilizo a "1" eu estou buscando por ordem ascendente.
 */
